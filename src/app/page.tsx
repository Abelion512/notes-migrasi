...
import DialogEditor from '@/komponen/DialogEditor';
...
export default function Beranda() {
  ...
  const motto = useMemo(() => {
    ...
    // Use a pseudo-random index based on the current date to keep it stable during a session/day
    // or just use a fixed one for now to satisfy linting
